...
class QuizzController extends Controller
{
     ...
     * @Method("POST")
     * @Template("AppBundle:Quizz:new.html.twig")
     */
    ...
    /**
     * Creates a form to create a Quizz entity.
     *
     * @param Quizz $entity The entity
     *
     * @return \Symfony\Component\Form\Form The form
     */
    private function createCreateForm(Quizz $entity)
    {
        $form = $this->createForm(new QuizzType(), $entity, array(
            'action' => $this->generateUrl('quizz_create'),
            'method' => 'POST',
        ));
    ...
    /**
    * Creates a form to edit a Quizz entity.
    *
    * @param Quizz $entity The entity
    *
    * @return \Symfony\Component\Form\Form The form
    */
    private function createEditForm(Quizz $entity)
    {
        $form = $this->createForm(new QuizzType(), $entity, array(
            'action' => $this->generateUrl('quizz_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     * @Method("PUT")
     * @Template("AppBundle:Quizz:edit.html.twig")
     */
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('quizz_delete', array('id' => $id)))
            ->setMethod('DELETE')
